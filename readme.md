...
1. ### 检索首页
   ...
   ![首页检索](FNSearch-master\img\首页检索.png)
   ...
   ![高级检索](FNSearch-master\img\高级检索.png)
...
2. ### 检索结果展示页
   ...
   ![img\检索结果.png](FNSearch-master\img\检索结果.png)
...
3. ### 论文详情页
   ...
   d)      如果后台返回有视频链接，可直接播放(仅支持存储到后台的视频 不支持在线视频)
	...
	![论文详情1](FNSearch-master\img\论文详情1.png)

	![论文详情2](FNSearch-master\img\论文详情2.png)
